...
export const translations = {
  pt: {
    ...
    'Explore the tools and services we\'ve built to help businesses grow.': 'Conheça as ferramentas e sistemas que criamos para acelerar o crescimento da sua empresa.',
    'All Solutions': 'Todas as Soluções',
    'All': 'Todos',
    'AI & Automation': 'IA & Automação',
    'Systems & Booking': 'Sistemas & Agendamento',
    'CRM & Sales': 'CRM & Vendas',
    'View Details': 'Ver Detalhes',
    'Live Tool': 'Acessar Ferramenta',
    'Fast 3-7 Day Deployment': 'Deploy Ágil em 3 a 7 Dias',
    'No endless wait to start scaling': 'Sem semanas de espera para começar',
    'Proprietary Ecosystem': 'Sistemas Validados',
    'Built specifically for high performance': 'Desenvolvidos para alta conversão',
    '24/7 AI Automation': 'Automação com IA 24/7',
    'Never lose a lead or booking': 'Nunca perca um lead ou agendamento',
    'Tailored Integration': 'Integração Sob Medida',
    'Direct sync with WhatsApp, CRM and payments': 'Conexão com WhatsApp, CRM e pagamentos',
    ...
    'No solutions found in this category.': 'Nenhuma solução encontrada nesta categoria.',
  }
} as const;
