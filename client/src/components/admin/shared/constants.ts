import { Building2, Briefcase, ClipboardList, FileText, HelpCircle, Image, LayoutDashboard, LayoutPanelLeft, Link, MessageSquare, Puzzle, Receipt, Search, Sparkles, Users, Smartphone, Presentation, RadioTower, Bell, TrendingUp, Cpu } from 'lucide-react';
