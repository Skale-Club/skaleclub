      ...
      <div className="flex items-center gap-4 select-none">
        ...
        <span 
          className={clsx(
            ...
            !isPortuguese ? "text-slate-900" : "text-gray-400"
          )}
        >
          EN
        </span>
        ...
        <button
          ...
          className="relative inline-flex h-10 w-20 items-center rounded-full bg-gray-300 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2"
          role="switch"
        ...
        >
          ...
          <span
            className={clsx(
              "relative inline-block h-8 w-8 transform rounded-full bg-white shadow-lg ring-0 transition-transform duration-200 ease-in-out",
              isPortuguese ? "translate-x-11" : "translate-x-1"
            )}
          >
