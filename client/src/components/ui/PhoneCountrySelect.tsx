  ...
  return (
    <div ref={rootRef} className={cn("relative shrink-0", className)}>
      <button
        ...
        className={cn(
          "flex min-h-10 w-auto shrink-0 items-center gap-2 bg-slate-50 px-3 text-sm font-medium text-slate-700 outline-none transition-colors hover:bg-slate-100 focus-visible:ring-2 focus-visible:ring-cta/30",
          buttonClassName,
        )}
      >
        <img
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  selected && "bg-cta/10 text-cta-hover",
                )}
              >
                <img
                ...
                {selected ? <Check className="h-4 w-4 text-cta" /> : null}
              </button>
            );
          })}
        </div>,
