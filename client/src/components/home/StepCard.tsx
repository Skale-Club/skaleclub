...
export const StepCard = memo(function StepCard({ step, index, stepLabel, whatWeDoLabel, outcomeLabel }: StepCardProps) {
  ...
  return (
    <div
      className="group relative overflow-visible rounded-2xl bg-white/90 border shadow-[0_24px_60px_-60px_rgba(15,23,42,0.45)] hover:-translate-y-2 hover:shadow-[0_28px_70px_-55px_rgba(23,37,84,0.4)] transition-all duration-300 backdrop-blur flex-shrink-0 w-full sm:w-[70%] md:w-[52%] tablet:w-[365px]"
    >
