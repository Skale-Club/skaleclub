...
export default function SkaleHubGroup() {
  ...
  return (
    <div className="flex-1 bg-[#0a0f0d] text-white">
      ...
      <section className="relative mx-auto flex w-full max-w-7xl flex-col items-center px-4 pt-[calc(5rem+36px)] pb-9 sm:px-6 lg:flex-row lg:items-start lg:gap-9 lg:px-8">
