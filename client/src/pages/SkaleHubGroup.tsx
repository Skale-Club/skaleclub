...
export default function SkaleHubGroup() {
  ...
  return (
    <div className="flex-1 bg-[#0a0f0d] text-white">
      ...
      <section className="relative mx-auto flex min-h-[calc(100vh-5rem)] max-w-5xl flex-col items-center justify-center px-4 py-20 sm:px-6 lg:flex-row lg:items-center lg:gap-16 lg:px-8">
                ...
                >
                  ...
                  <div className={`flex overflow-hidden rounded-xl border bg-white/5 transition-colors ${phoneError ? "border-red-300" : "border-white/10 focus-within:border-[#25D366]"}`}>
                    <PhoneCountrySelect
                      ...
                      buttonClassName="min-h-12 rounded-none border-0 bg-transparent"
                    />
                    <Input
                      type="tel"
                      inputMode="tel"
