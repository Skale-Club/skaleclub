...
import { Sparkles, PhoneCall, Home } from "lucide-react";
...
export default function LeadThankYou() {
  ...
  const companyName = companySettings?.companyName || "Nossa equipe";

  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white px-4">
      <div className="max-w-4xl w-full grid md:grid-cols-[1.2fr_1fr] gap-6 items-center">
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl backdrop-blur">
          ...
          <div className="mt-6 grid sm:grid-cols-2 gap-3">
            ...
            <Link href="/contact">
              <button className="w-full inline-flex items-center justify-center gap-2 rounded-xl border border-white/30 text-white font-semibold py-3 hover:bg-white/10 transition-all">
