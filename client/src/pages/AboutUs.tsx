    ...
    <div className="pt-24 pb-20">
      <section className="container-custom mx-auto mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
          {[
            ...
            { icon: Users, title: t("Professional Team"), desc: t("Experienced and highly trained specialists.") },
            { icon: Award, title: t("Premium Service"), desc: t("Transparent pricing and clear project scope.") }
          ].map((item, i) => (
      ...
      <section className="bg-slate-900 text-white py-20">
        <div className="container-custom mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">{t('Our Mission')}</h2>
            <p className="text-lg text-slate-300 mb-8 leading-relaxed">
              {t('To provide top-tier marketing services that help you grow your business, allowing you to focus on what matters most. We use data-driven strategies and proven techniques to ensure real results for your company.')}
            </p>
          </div>
