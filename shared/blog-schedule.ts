// =============================================================================
// shared/blog-schedule.ts
//
// SOURCE OF TRUTH: xkedule/shared/blog-schedule.ts — sync changes back.
// Ported here as part of the auto-blog parity work (autoblog-parity SC-06, see
// .planning/initiatives/autoblog-parity/MASTER.md §5). Byte-identical to the
// original below this header: it is pure, takes its own clock, and has no
// notion of tenancy, so nothing needed adapting.
// =============================================================================
