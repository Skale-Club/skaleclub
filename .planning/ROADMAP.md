...
Plans:
- [x] 37-01-PLAN.md — Storage joins (listRssItemsByStatus, listBlogGenerationJobs, getBlogGenerationJob) + GET /api/blog/health endpoint (BLOG2-08, BLOG2-10, BLOG2-12)
- [x] 37-02-PLAN.md — 10 admin REST endpoints (sources CRUD, queue, jobs+retry/cancel, preview/from-preview) + runPreview() helper in blog-generator.ts (BLOG2-07, BLOG2-08, BLOG2-09, BLOG2-10, BLOG2-11)
- [x] 37-03-PLAN.md — 6 new files under client/src/components/admin/blog/ + BlogSection third tab + translations.ts compaction (BLOG2-07, BLOG2-08, BLOG2-09, BLOG2-10, BLOG2-11, BLOG2-12, BLOG2-13)
...
**Plans:** 3 plans (3 waves — strict dependency chain per CONTEXT D-06)
**Success Criteria** (what must be TRUE):
...
Plans:
- [ ] 38-01-PLAN.md — durations_ms JSONB migration + Drizzle/Zod schema (foundation; no behavior change) (BLOG2-15)
...
| 38. Dynamic Cron & Observability | v1.9 | 0/3 | Planned     | -          |
| 31. Schema & Templates Foundation | v1.8 | 2/2 | Complete | 2026-05-04 |
| 32. Telegram Integration | v1.8 | 2/2 | Complete | 2026-05-04 |
| 33. Admin Notifications Panel | v1.8 | 2/2 | Complete | 2026-05-04 |
